...
<body>
    <div class="white">
        ...
        <form class="add" action="{{url('crearTipo')}}" method="GET">
    ...
    <img src="./media/lugares.png" name="back" value="back" width="50px" height="50px" style="padding: 0px 0px 10px 10px">
</body>
