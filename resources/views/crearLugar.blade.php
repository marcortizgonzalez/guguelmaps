    ...
    <center>
        <form class="cuadro_login" action="{{url('crearLugar')}}" method="post" enctype="multipart/form-data">
            ...
            <p>Nombre:</p>
                ...
                @enderror
            <p>Coordenadas:</p>
            <p>	(Ejemplo: 41.38390263173808, 2.181783655164913)</p>
                ...
                @enderror
            <p>Direccion:</p>
                <input class="btn-outline-success" type="text" name="direccion_lugar">
                @error('direccion_lugar')
                    <br>
                    {{$message}}
                @enderror
            <p>Telf:</p>
                <input class="btn-outline-success" type="number" name="telf_lugar">
                @error('telf_lugar')
                    <br>
                    {{$message}}
                @enderror
