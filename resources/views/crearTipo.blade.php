            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        <h3>Crear Tipo de sitio</h3>
                        <form action="{{url('crearTipo')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            {{method_field('POST')}}

                            <div class="col-md-12">
                                <p>Nombre:</p>
                                    <input class="form-control" type="text" name="nombre_tipo" required>
                                    @error('nombre_tipo')
                                        <br>
                                        {{$message}}
                                    @enderror
                            ...
                            <div class="col-md-12">
                                <p>Icono FontAwesome: (Ejemplo: fas fa-laugh-beam)</p>
                                    <input class="form-control" type="text" name="icono_tipo" required>
                                    @error('icono_tipo')
                                        <br>
                                        {{$message}}
                                    @enderror
