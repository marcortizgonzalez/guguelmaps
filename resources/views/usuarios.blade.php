...
<head>
    ...
    <script src="{!! asset('js/ajaxUsuario.js') !!}"></script>
...
<body>
    <div class="white">
        ...
        <form class="add" action="{{url('crearUser')}}" method="GET">
    ...
    <img src="./media/usuario.png" name="back" value="back" width="50px" height="50px" style="padding: 0px 0px 10px 10px">
</body>
